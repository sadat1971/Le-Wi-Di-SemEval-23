...
def tokenization_for_BERT(df, path="/media2/sadat/Sadat/SemEval23_Le_Wi_Di/Convabuse/Data/", filename="put_the_filename_here", saveit="No"):
...
parser.add_argument("--data_dir", 
                    type=str, 
                    default="/media2/sadat/Sadat/SemEval23_Le_Wi_Di/Convabuse/Data/",
                     help="Input data path.")
parser.add_argument("--log_dir",
                     type=str, 
                     default="/media2/sadat/Sadat/SemEval23_Le_Wi_Di/Convabuse/Result/SafeWebUH/",
                     help="Store result path.")
parser.add_argument("--model_path_dir",
                     type=str, 
                     default="/media2/sadat/Sadat/SemEval23_Le_Wi_Di/Convabuse/Result/",
                     help="Store result path.")
